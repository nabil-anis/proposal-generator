      ...
      ">
        ...
        <div className="px-6 py-5 border-b border-black/5 dark:border-white/10 flex justify-between items-center bg-white/50 dark:bg-white/5 backdrop-blur-md shrink-0">
          <div className="flex items-center gap-3">
            ...
            <button 
              onClick={toggleLock}
              className={`
                ml-4 px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all
                ${data.isLocked 
        ...
        <div className="p-6 space-y-8 overflow-y-auto scrollbar-hide bg-gray-50/30 dark:bg-black/20">
          ...
          <div className="space-y-3">
            ...
            <div className={`h-32 ml-8 glass-panel rounded-xl p-1 bg-white/40 dark:bg-black/20 ${data.isLocked ? 'opacity-60 pointer-events-none' : ''}`}>
              <TextArea 
          ...
          <div className="space-y-4">
            ...
            <div className="ml-8 space-y-3">
              ...
              {data.examples.map((ex, idx) => (
                <div key={idx} className="group relative glass-panel bg-white/60 dark:bg-zinc-800/40 p-4 rounded-xl border border-white/20 dark:border-white/5 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                  ...
                  {!data.isLocked && (
                    <button 
                      ...
                      className="absolute top-2 right-2 p-1.5 rounded-full bg-red-50 dark:bg-red-900/20 text-red-400 hover:text-red-600 hover:bg-red-100 transition-colors opacity-0 group-hover:opacity-100"
              ...
              {!data.isLocked && (
                <div className="mt-2">
                  {!isAddingExample ? (
                    ...
                    <div className="glass-panel p-2 rounded-xl bg-white dark:bg-zinc-800 animate-fade-in-up">
                      ...
                      <div className="flex justify-end gap-2">
                        <button 
                          ...
                          className="px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 dark:text-zinc-400 dark:hover:text-zinc-200"
                        >
                          Cancel
                        </button>
                        <button 
