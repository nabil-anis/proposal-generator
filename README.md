...
To enable cross-device sync, you need a Supabase project.

1.  **Create a Project**: Go to [Supabase](https://supabase.com) and create a new project.
2.  **Run SQL Setup**: Execute the following SQL in your Supabase SQL Editor to create the necessary table and security policies:

```sql
-- Create the table to store training data
